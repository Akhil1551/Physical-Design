...
## Create a route type to define the NDR & lyaers to use for routing the clock tree:
create_route_type -name clkroute -non_default_rule 2w2s -bottom_preferred_layer Metal5 -top_preferred_layer Metal6

## sepecify this route type should be used for trunk and leaf nets:
set_ccopt_property route_type clkroute -net_type trunk
set_ccopt_property route_type clkroute -net_type leaf 

## sepecify the Clock Buffer, Clock Inverter & Clock Gating Cells to use:
